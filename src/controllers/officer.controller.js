...
exports.updatePanchayatAdmin = async (req, res, next) => {
  try {
    ...
    if (panchayat_aadhaar_no !== undefined && panchayat_aadhaar_no !== null && String(panchayat_aadhaar_no).trim() !== "") {
      payload.panchayat_aadhaar_no = String(panchayat_aadhaar_no).trim();
    }
